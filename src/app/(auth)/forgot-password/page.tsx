        ...
        <div className="bg-white rounded-2xl border border-[#E5E7EB] shadow-[0_2px_16px_0_rgba(22,23,14,0.06)] p-6">
          {sent ? (
            <div className="space-y-4 text-center">
              ...
              <div>
                <p className="text-sm font-semibold text-[#0B1220]">Email envoyé</p>
              ...
              <Link
                href="/login"
                className="inline-flex h-9 w-full items-center justify-center rounded-lg border border-[#E5E7EB] bg-white px-4 text-sm font-semibold text-[#0B1220] transition-colors hover:bg-[#F7F8FA]"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-1.5">
                <Label htmlFor="email" className="text-[11px] font-semibold text-[#475569] uppercase tracking-[0.06em]">
                  Email
                </Label>
                <Input
                  id="email"
